...
function ClassDetail({match}){
  ...
  useEffect(() => {
    ...
    fetch("https://myclassroom-api.herokuapp.com/class/" + match.params.id, {
    ...
    // Get Role
    fetch("https://myclassroom-api.herokuapp.com/class/" + match.params.id + "/role", {
      headers: {'Content-Type':'application/json',
                Authorization: 'Bearer ' + token},
    })
      .then(res => {
  ...
  const inviteTeacher = (email) => {
    ...
    fetch("https://myclassroom-api.herokuapp.com/class/" + classDetail.id + "/invite?role=Teacher", {
      method: 'POST',
      headers: {'Content-Type':'application/json',
                Authorization: 'Bearer ' + token},
      body: JSON.stringify({
  ...
  const inviteStudent = (email) => {
    ...
    fetch("https://myclassroom-api.herokuapp.com/class/" + classDetail.id + "/invite?role=Student", {
      method: 'POST',
      headers: {'Content-Type':'application/json',
                Authorization: 'Bearer ' + token},
      body: JSON.stringify({
